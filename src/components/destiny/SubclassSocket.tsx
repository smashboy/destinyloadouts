...
export const SubclassSocket: React.FC<SubclassSocketProps> = ({
  ...
  <HoverCard openDelay={100} closeDelay={100}>
    <HoverCardTrigger>
      <button className="relative h-12 w-12 rotate-45 rounded transition duration-300 ease-out hover:ring-2 hover:ring-slate-300 hover:ring-offset-4 focus:outline-none focus:ring-2 focus:ring-slate-300 focus:ring-offset-4">
